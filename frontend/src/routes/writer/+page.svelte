  ...
  const sections = [
    {
      ...
      content:
        "Our GenAI-powered healthcare diagnostics platform leverages cutting-edge computer vision and large language models to revolutionize early disease detection. With a proven 98% accuracy rate in tumor detection and scalable architecture, we address the critical need for accessible, accurate, and affordable diagnostic solutions in underserved communities.",
      wordCount: 156,
    },
    {
      id: "technical",
    ...
    },
    {
      ...
      content:
        "Our interdisciplinary team combines 80+ years of collective experience in AI research, medical diagnostics, and healthcare innovation. Led by Dr. Ana Silva (PhD in Computer Vision, 15+ publications in top-tier conferences) and Dr. João Santos (MD with 20 years in radiology), the team has successfully delivered 3 previous EU-funded projects with measurable impact on patient outcomes.",
      wordCount: 198,
    },
  ];
          ...
          <CardContent class="p-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-2">
                ...
                <Button
                  variant="outline"
                  class="border-accent/30 hover:bg-accent/10"
                >
                  <FileText class="w-4 h-4 mr-2" />
                  JSON
                </Button>
        ...
        <Card class="glass-card border-secondary/30 sticky top-6">
          ...
          <CardContent class="space-y-4">
            {#each inspirationCases as case_}
              <div
                class="p-4 bg-muted/20 rounded-lg border border-border hover:border-secondary/30 transition-colors cursor-pointer"
              >
                <div class="flex items-start justify-between mb-2">
                  <h4
                    class="font-semibold text-sm text-foreground leading-tight"
                  >
                    {case_.title}
                  </h4>
                  <Badge
                    class="bg-accent/20 text-accent border-accent/30 text-xs"
                    >{case_.success}</Badge
                  >
                </div>
            ...
            <Button
              class="w-full bg-gradient-to-r from-primary to-secondary hover:opacity-90 neon-glow-purple mt-4"
            >
              View All Examples
            </Button>
          </CardContent>
